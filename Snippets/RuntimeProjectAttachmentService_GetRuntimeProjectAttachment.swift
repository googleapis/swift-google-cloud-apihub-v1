...
func sample(
  ...
  let response = try await client.getRuntimeProjectAttachment(
    request: GetRuntimeProjectAttachmentRequest()
      .with {
        $0.name =
          "projects/\(projectId)/locations/\(locationId)/runtimeProjectAttachments/\(runtimeProjectAttachmentId)"
      }
  )
  ...
  static func main() async throws {
    do {
      ...
      try await sample(
        ...
        runtimeProjectAttachmentId: "[placeholder]")
    } catch {
      print("Error: \(error)")
    }
  }
