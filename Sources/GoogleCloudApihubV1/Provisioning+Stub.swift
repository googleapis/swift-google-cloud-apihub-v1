...
extension Clients {
  ...
  class ProvisioningTransport: ProvisioningStub {
    ...
    public func createApiHubInstance(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/apiHubInstances"
      }()
      var query = [
    ...
    public func getApiHubInstance(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudApihubV1.ApiHubInstance.self, from: data)
    }
    ...
    public func lookupApiHubInstance(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/apiHubInstances:lookup"
      }()
      let query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
      ]
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudApihubV1.LookupApiHubInstanceResponse.self, from: data)
    }
