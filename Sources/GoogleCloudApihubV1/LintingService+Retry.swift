...
extension Clients {
  final class LintingServiceRetry: LintingServiceStub {
    let inner: any LintingServiceStub
    let options: GoogleCloudGax.ClientOptions

    public init(_ inner: any LintingServiceStub, options: GoogleCloudGax.ClientOptions) {
      self.inner = inner
    ...
    public func getStyleGuide(
      ...
      try await self._intercept(
        ...
        idempotent: true,
        action: {
          (r: GetStyleGuideRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleCloudApihubV1.StyleGuide
          in
          return try await self.inner.getStyleGuide(request: r, options: o)
        })
    }
    ...
    public func updateStyleGuide(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: UpdateStyleGuideRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleCloudApihubV1.StyleGuide
          in
          return try await self.inner.updateStyleGuide(request: r, options: o)
        })
    }
    ...
    public func getStyleGuideContents(
      ...
      try await self._intercept(
        ...
        idempotent: true,
        action: {
          (r: GetStyleGuideContentsRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleCloudApihubV1.StyleGuideContents
          in
          return try await self.inner.getStyleGuideContents(request: r, options: o)
        })
    }
    ...
    public func lintSpec(
      ...
      try await self._intercept(
        ...
        options: options,
        idempotent: false,
        action: { (r: LintSpecRequest, o: GoogleCloudGax.RequestOptions) async throws -> Void in
          return try await self.inner.lintSpec(request: r, options: o)
        })
    }
