...
extension Clients {
  ...
  class ApiHubCurateTransport: ApiHubCurateStub {
    ...
    public func createCuration(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/curations"
      }()
      var query = [
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudApihubV1.Curation.self, from: data)
    }
    ...
    public func listCurations(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudApihubV1.ListCurationsResponse.self, from: data)
    }
    ...
    public func updateCuration(
      ...
      let path = try { () throws -> Swift.String in
        guard let pathVariable0 = request.curation.map({ $0.name }), !pathVariable0.isEmpty else {
          throw GoogleCloudGax.RequestError.binding(
            "'request.curation.name' is not set or is empty")
        }
        return "/v1/\(pathVariable0)"
      }()
      var query = [
