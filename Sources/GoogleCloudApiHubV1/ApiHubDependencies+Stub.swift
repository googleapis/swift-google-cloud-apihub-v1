...
extension Clients {
  protocol ApiHubDependenciesStub {
  ...
  class ApiHubDependenciesTransport: ApiHubDependenciesStub {
    ...
    public func createDependency(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/dependencies"
      }()
      var query = [
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudApiHubV1.Dependency.self, from: data)
    }
    ...
    public func updateDependency(
      ...
      let path = try { () throws -> Swift.String in
        guard let pathVariable0 = request.dependency.map({ $0.name }), !pathVariable0.isEmpty else {
          throw GoogleCloudGax.RequestError.binding(
            "'request.dependency.name' is not set or is empty")
        }
        return "/v1/\(pathVariable0)"
      }()
      var query = [
    ...
    public func listDependencies(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudApiHubV1.ListDependenciesResponse.self, from: data)
    }
