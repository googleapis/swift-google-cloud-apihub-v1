...
/// method's request.
///
/// [google.cloud.apihub.v1.ApiHubPlugin.CreatePluginInstance]: <doc:ApiHubPluginClient/createPluginInstance(request:)>
public struct CreatePluginInstanceRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
