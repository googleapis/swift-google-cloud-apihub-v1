...
extension Clients {
  final class HostProjectRegistrationServiceRetry: HostProjectRegistrationServiceStub {
    ...
    public init(_ inner: any HostProjectRegistrationServiceStub, options: GoogleGax.ClientOptions) {
      self.inner = inner
    ...
    public func createHostProjectRegistration(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: CreateHostProjectRegistrationRequest, o: GoogleGax.RequestOptions) async throws
    ...
    public func getHostProjectRegistration(
      ...
      try await self._intercept(
        ...
        idempotent: true,
        action: {
          (r: GetHostProjectRegistrationRequest, o: GoogleGax.RequestOptions) async throws
            -> GoogleCloudApiHubV1.HostProjectRegistration
          in
    ...
    public func listHostProjectRegistrations(
      ...
      try await self._intercept(
        ...
        idempotent: true,
        action: {
          (r: ListHostProjectRegistrationsRequest, o: GoogleGax.RequestOptions) async throws
