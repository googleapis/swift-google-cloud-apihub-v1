...
extension Clients {
  final class HostProjectRegistrationServiceRetry: HostProjectRegistrationServiceStub {
    let inner: any HostProjectRegistrationServiceStub
    let options: GoogleCloudGax.ClientOptions

    public init(
      _ inner: any HostProjectRegistrationServiceStub, options: GoogleCloudGax.ClientOptions
    ) {
      self.inner = inner
    ...
    public func createHostProjectRegistration(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: CreateHostProjectRegistrationRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleCloudApiHubV1.HostProjectRegistration
          in
          return try await self.inner.createHostProjectRegistration(request: r, options: o)
        })
    }
    ...
    public func getHostProjectRegistration(
      ...
      try await self._intercept(
        ...
        idempotent: true,
        action: {
          (r: GetHostProjectRegistrationRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleCloudApiHubV1.HostProjectRegistration
          in
          return try await self.inner.getHostProjectRegistration(request: r, options: o)
        })
    }
    ...
    public func listHostProjectRegistrations(
      ...
      try await self._intercept(
        ...
        idempotent: true,
        action: {
          (r: ListHostProjectRegistrationsRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleCloudApiHubV1.ListHostProjectRegistrationsResponse
          in
          return try await self.inner.listHostProjectRegistrations(request: r, options: o)
        })
    }
