...
extension Clients {
  final class LintingServiceRetry: LintingServiceStub {
    ...
    public init(_ inner: any LintingServiceStub, options: GoogleGax.ClientOptions) {
      self.inner = inner
    ...
    public func getStyleGuide(
      ...
      try await self._intercept(
        ...
        idempotent: true,
        action: {
          (r: GetStyleGuideRequest, o: GoogleGax.RequestOptions) async throws
    ...
    public func updateStyleGuide(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: UpdateStyleGuideRequest, o: GoogleGax.RequestOptions) async throws
            -> GoogleCloudApiHubV1.StyleGuide
          in
    ...
    public func getStyleGuideContents(
      ...
      try await self._intercept(
        ...
        idempotent: true,
        action: {
          (r: GetStyleGuideContentsRequest, o: GoogleGax.RequestOptions) async throws
    ...
    public func lintSpec(
      ...
      try await self._intercept(
        ...
        options: options,
        idempotent: false,
        action: { (r: LintSpecRequest, o: GoogleGax.RequestOptions) async throws -> Void in
