...
extension Clients {
  ...
  class RuntimeProjectAttachmentServiceTransport: RuntimeProjectAttachmentServiceStub {
    ...
    public func createRuntimeProjectAttachment(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/runtimeProjectAttachments"
      }()
      var query = [
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudApiHubV1.RuntimeProjectAttachment.self, from: data)
    }
    ...
    public func listRuntimeProjectAttachments(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudApiHubV1.ListRuntimeProjectAttachmentsResponse.self, from: data)
    }
    ...
    public func lookupRuntimeProjectAttachment(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0):lookupRuntimeProjectAttachment"
      }()
      let query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
      ]
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudApiHubV1.LookupRuntimeProjectAttachmentResponse.self, from: data)
    }
