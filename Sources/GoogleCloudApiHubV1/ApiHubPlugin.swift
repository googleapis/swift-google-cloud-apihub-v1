  ...
  public func createPluginInstance(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try PluginInstance(fromAny: anyValueUnwrapped)
  ...
  public func executePluginInstanceAction(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try ExecutePluginInstanceActionResponse(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func enablePluginInstanceAction(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try EnablePluginInstanceActionResponse(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
  ...
  public func disablePluginInstanceAction(
    ...
    let extractStatus = {
      ...
      case .response(let anyValue):
        ...
        let response = try DisablePluginInstanceActionResponse(fromAny: anyValueUnwrapped)
        return .init(done: true, result: .success(response))
      case .error(let status):
        guard let statusUnwrapped = status else {
          return .init(
