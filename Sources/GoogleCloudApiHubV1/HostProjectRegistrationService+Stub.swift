  ...
  class HostProjectRegistrationServiceTransport: HostProjectRegistrationServiceStub {
    ...
    public func createHostProjectRegistration(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/hostProjectRegistrations"
      }()
      var query = [
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudApiHubV1.HostProjectRegistration.self, from: data)
    }
    ...
    public func listHostProjectRegistrations(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudApiHubV1.ListHostProjectRegistrationsResponse.self, from: data)
    }
