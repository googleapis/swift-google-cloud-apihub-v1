...
extension Clients {
  final class ApiHubCollectRetry: ApiHubCollectStub {
    let inner: any ApiHubCollectStub
    let options: GoogleCloudGax.ClientOptions

    public init(_ inner: any ApiHubCollectStub, options: GoogleCloudGax.ClientOptions) {
      self.inner = inner
    ...
    public func collectApiData(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: CollectApiDataRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleLongrunning.Operation
          in
          return try await self.inner.collectApiData(request: r, options: o)
        })
    }
