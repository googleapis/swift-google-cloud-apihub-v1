  ...
  class ApiHubPluginTransport: ApiHubPluginStub {
    ...
    public func getPlugin(
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudApiHubV1.Plugin.self, from: data)
    }
    ...
    public func listPlugins(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudApiHubV1.ListPluginsResponse.self, from: data)
    }
    ...
    public func getPluginInstance(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudApiHubV1.PluginInstance.self, from: data)
    }
    ...
    public func listPluginInstances(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudApiHubV1.ListPluginInstancesResponse.self, from: data)
    }
