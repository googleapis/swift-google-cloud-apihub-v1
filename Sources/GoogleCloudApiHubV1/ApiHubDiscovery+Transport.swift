...
extension Clients {
  class ApiHubDiscoveryTransport: ApiHubDiscoveryStub {
    ...
    public func listDiscoveredApiObservations(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/discoveredApiObservations"
      }()
      var query = [
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudApiHubV1.ListDiscoveredApiObservationsResponse.self, from: data)
    }
    ...
    public func getDiscoveredApiObservation(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudApiHubV1.DiscoveredApiObservation.self, from: data)
    }
    ...
    public func listDiscoveredApiOperations(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/discoveredApiOperations"
      }()
      var query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
      ]
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudApiHubV1.ListDiscoveredApiOperationsResponse.self, from: data)
    }
    ...
    public func getDiscoveredApiOperation(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudApiHubV1.DiscoveredApiOperation.self, from: data)
    }
