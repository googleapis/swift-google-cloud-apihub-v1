...
extension Clients {
  final class RuntimeProjectAttachmentServiceRetry: RuntimeProjectAttachmentServiceStub {
    ...
    public init(_ inner: any RuntimeProjectAttachmentServiceStub, options: GoogleGax.ClientOptions)
    {
      self.inner = inner
    ...
    public func createRuntimeProjectAttachment(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: CreateRuntimeProjectAttachmentRequest, o: GoogleGax.RequestOptions) async throws
    ...
    public func getRuntimeProjectAttachment(
      ...
      try await self._intercept(
        ...
        idempotent: true,
        action: {
          (r: GetRuntimeProjectAttachmentRequest, o: GoogleGax.RequestOptions) async throws
            -> GoogleCloudApiHubV1.RuntimeProjectAttachment
          in
    ...
    public func listRuntimeProjectAttachments(
      ...
      try await self._intercept(
        ...
        idempotent: true,
        action: {
          (r: ListRuntimeProjectAttachmentsRequest, o: GoogleGax.RequestOptions) async throws
    ...
    public func deleteRuntimeProjectAttachment(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: DeleteRuntimeProjectAttachmentRequest, o: GoogleGax.RequestOptions) async throws
            -> Void in
    ...
    public func lookupRuntimeProjectAttachment(
      ...
      try await self._intercept(
        ...
        idempotent: true,
        action: {
          (r: LookupRuntimeProjectAttachmentRequest, o: GoogleGax.RequestOptions) async throws
